...
class UserController extends BaseController{
	...
	public function getDesc(){
		return [
			...
			'actions' => [
				...
				'updateSelfInfo'     => '用户修改自己的资料',
				'updateSelfPass'     => '用户修改自己的密码',
			]
		];
	}
	...
	public function addUser(){
		$data = [
			...
			'email'    => IO::I('email'),
			'group'    => IO::I('group', null, 'uint'),
			'accname'	 => IO::I('accname'),
			'cellphone'=> IO::I('cellphone'),
		];
	...
	public function updateSelfPass(){
		$password = IO::I('password');

		$uid = User::get_login()['id'];
		$salt = User::get_login()['salt'];

		$data = [
			'password'=> User::make_pass($password, $salt),
		];
