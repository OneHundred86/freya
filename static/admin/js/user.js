$(function(){
	...
	var userList = ui('#user-list', {
		extend : {
			...
			add : function(x){
				...
				e.ddAccountName = ui(e.dwEditFrame.dwRowAccountName.dwTB);
                e.ddCellphone   = ui(e.dwEditFrame.dwRowCellphone.dwTB);
                ...
                e.refresh = function(d){
                    ...
                    e.ddAccountName.val(d.accname);
                    e.ddCellphone.val(d.cellphone);
		...
		switch(this.dataset.action){
			...
			case 'save':
				...
				G.call('user.editUser', {
					...
					email    : p.ddEmail.val(),
					group    : p.ddGroup.val(),
                    accname  : p.ddAccountName.val(),
                    cellphone: p.ddCellphone.val(),
	...
	var btnAddSave     = ui('#btn-add-save', {
		click : function(){
			...
			var accname =  iptAddAccName.val();
			var cellphone = iptAddCellphone.val();
